...
const SaveBtn = ({ data }) => {
  ...
  return (
    <button
      className="outline-0 border-0 bg-none cursor-pointer text-black"
...
const Saved = () => {
  ...
  return (
    <section className="w-[80%] h-full flex flex-col mt-16 mb-24 relative text-black">
      <div className="w-full min-h-[60vh] py-8  border border-gray-100 rounded text-black">
        {savedData ? (
          <table className="w-full table-auto">
            <thead className="capitalize text-base text-black font-medium border-b border-gray-100 ">
              <tr>
                <th className="py-1 text-black">asset</th>
                <th className="py-1 text-black">name</th>
                <th className="py-1 text-black">price</th>
                <th className="py-1 text-black">total volume</th>
                <th className="py-1 text-black">market cap change</th>
                <th className="py-1 text-black">1H</th>
                <th className="py-1 text-black">24H</th>
                <th className="py-1 text-black">7D</th>
              </tr>
            </thead>
            <tbody>
              {savedData &&
                savedData.map((data) => {
                  return (
                    ...
                    >
                      <td className="py-4 uppercase flex items-center text-black">
                        <SaveBtn data={data} />
          ...
          <h1 className="min-h-[60vh] text-lg text-cyan flex items-center justify-center text-black">
            There is no data to display!
          </h1>
        )}
        <button
          className="w-[2rem] ml-4 hover:scale-110 transition-all transition-ease
        absolute right-0 -top-10 text-black
        "
