...
const Filters = () => {
  ...
  return (
    <div
      className="text-black w-full h-24 rounded-lg
    flex items-center justify-between relative -mt-10 search-container
    "
    >
      <Search />
      <div className="flex mr-7 text-md">
        {/* <form
     ...
     '
        ...
        <label className="relative flex justify-center items-center">
         ...
         "
            onClick={handleSort}
          >
            <option value="market_cap_desc" className="text-black">
              market cap desc
            </option>
            <option value="market_cap_asc" className="text-black">
              market cap asc
            </option>
            <option value="volume_desc" className="text-black">
              volume desc
            </option>
            <option value="volume_asc" className="text-black">
              volume asc
            </option>
            <option value="id_desc " className="text-black">
              id desc
            </option>
            <option value="id_asc" className="text-black">
              id asc
            </option>
            <option value="gecko_desc" className="text-black">
              gecko desc
            </option>
            <option value="gecko_asc" className="text-black">
              gecko asc
            </option>
          </select>
          <img
