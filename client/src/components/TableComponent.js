...
const TableComponent = () => {
  ...
  return (
    <>
      <div className="flex flex-col mt-12 rounded-2xl table-container p-5">
        {cryptoData ? (
            ...
            <tbody>
              {cryptoData.map((data) => {
                return (
                  <tr
                    key={data.id}
                    className="text-center text-black hover:bg-gray-200 last:border-b-0 rounded-2xl"
                  >
          ...
          <div className="w-full min-h-[50vh] flex justify-center items-center">
            <div
              ...
              role="status"
            />
            <span className="text-black ml-2">please wait...</span>
          </div>
        ) : error.data || error.search ? (
