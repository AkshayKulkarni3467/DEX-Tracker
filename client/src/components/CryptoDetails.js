...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    ...
    backdrop-blur-sm flex items-center justify-center font-nunito text-black
    "
      onClick={close}
    >
      <div
        className="w-[65%] h-[75%] bg-gray-300 bg-opacity-75 rounded-lg text-black relative"
      ...
      >
            ...
            <div className="flex flex-col w-[45%] h-full pr-2 ">
              <div className="flex w-full items-center">
                <img
                  ...
                  alt={data.id}
                />
                <h1 className="text-xl capitalize font-medium text-black">
                  {data.name}
                </h1>
                <span
                  className="text-sm
        ...
        "
              ...
              <div className="flex w-full mt-6">
                <div className="flex flex-col w-full">
                  <div className="flex justify-between">
                    <span className="text-sm capitalize text-black">Price</span>
                    <div
          ...
          `}
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-black">Low 24H</span>
                  <h2 className="text-black font-bold">
                    {new Intl.NumberFormat("en-IN", {
                      style: "currency",
                      currency: currency,
            ...
            <div className="flex flex-col w-[55%] h-full pl-3 ">
              ...
              <div className="flex flex-col mt-4">
                <h3 className="text-black py-1">
                  <span className="text-black capitalize mr-1 text-black">
                    market cap rank:{" "}
                  </span>{" "}
                ...
                <h3 className="text-black py-1">
                  <span className="text-black capitalize mr-1">
                    coinGecko rank:{" "}
                  </span>{" "}
                  {data.coingecko_rank}{" "}
                </h3>
